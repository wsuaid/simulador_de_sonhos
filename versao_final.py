...
# Adicionado CSS para melhorar a visualização em telemóveis e ajustar espaçamentos
st.markdown("""
<style>
/* Media query para ecrãs pequenos como os de telemóvel */
@media (max-width: 768px) {
    ...
    /* Diminui o tamanho do texto normal e dos inputs */
    .stTextInput, .stMarkdown, .stRadio, .stCaption {
...
# --- VARIAVEIS GLOBAIS ---
# Pra guarda oq o usuario digita
...
st.markdown("---")
st.caption("Aviso Importante: Os valores aqui são só ilustrativos pra ajudar a entender e não são garantia de ganho. Pra achar o melhor investimento pra você, fale com nossos consultores.")
